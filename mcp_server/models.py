...
#   timestamp: 2025-06-28T15:33:26+00:00
...
class CertificateParameters(BaseModel):
    ...
    rollno: str = Field(..., description='Roll No', examples=['000XXXX'])
    year: str = Field(..., description='Year', examples=['2013,2014,2015,2016,2017'])
